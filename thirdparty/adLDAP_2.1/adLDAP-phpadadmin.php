...
class adLDAP {
	...
	function adldap_schema($attributes){
		...
		if ($attributes["extensionattribute2"]){ $mod["extensionattribute2"][0]=$attributes["extensionattribute2"]; }
		if ($attributes["extensionattribute3"]){ $mod["extensionattribute3"][0]=$attributes["extensionattribute3"]; }
		if ($attributes["extensionattribute4"]){ $mod["extensionattribute4"][0]=$attributes["extensionattribute4"]; }
		if ($attributes["extensionattribute5"]){ $mod["extensionattribute5"][0]=$attributes["extensionattribute5"]; }
		if ($attributes["extensionattribute6"]){ $mod["extensionattribute6"][0]=$attributes["extensionattribute6"]; }
